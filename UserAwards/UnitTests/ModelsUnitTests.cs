...
namespace UnitTests
{
	...
	public class ModelsUnitTests
	{
		...
		public void CreatePerson()
		{
			...
			{
				Birthdate = DateTime.Parse("10/01/1980"),
				Id = Guid.Parse("7816ec31-2185-4e0f-a32c-64d970eff4d8"),
				Name = "Test"
			};
			...
			Assert.AreEqual(cntBefore + 1, cntAfter,"Error in created person...");
		}
		...
		public void CreateAward()
		{
			...
			AwardHelper.CreateEntity(awardModel);
			var cntAfter = AwardHelper.AwardModelList.Count;

			Assert.AreEqual(cntBefore + 1, cntAfter, "Error in created award...");
		}
		...
		{
			var deleteAwardId = Guid.Parse("7816ec31-2185-4e0f-a32c-64d970eff001");

			var cntBefore = AwardHelper.AwardModelList.Count;
			AwardHelper.DeleteEntity(deleteAwardId);
			var cntAfter = AwardHelper.AwardModelList.Count;

			Assert.AreEqual(cntBefore, cntAfter + 1, "Error in delete award...");
		}
	}
}
